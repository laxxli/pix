...
describe('Unit | Domain | Models | CertificationAssessment', () => {
  ...
  describe('#neutralizeChallengeByNumberIfKoOrSkipped', () => {
    ...
    it('should neutralize the challenge when the answer is ko', () => {
      ...
      // when
      certificationAssessment.neutralizeChallengeByNumberIfKoOrSkipped(1);
    ...
    it('should throw when the challenge is not asked', async () => {
      // given
      const certificationAssessment = domainBuilder.buildCertificationAssessment({
        id: 123,
        userId: 123,
      ...
      // when / then
      expect(() => { certificationAssessment.neutralizeChallengeByNumberIfKoOrSkipped(66); })
        .to.throw(ChallengeToBeNeutralizedNotFoundError);
    });
  });
