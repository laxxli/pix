...
export default class ResumeRoute extends Route {
  ...
  _routeToNextChallenge(assessment) {
    return this.replaceWith('assessments.challenge', assessment.id, assessment.challengeNumber, { queryParams: { newLevel: this.newLevel, competenceLeveled: this.competenceLeveled } });
  }
